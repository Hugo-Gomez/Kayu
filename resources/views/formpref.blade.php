                ...
                <div class="x_content">
                  {!! Form::open(array('url' => '/formpref', 'class' => 'form-horizontal form-label-left')) !!}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-5 col-sm-7 col-xs-12">
                          {{ Form::select('salt', array('low' => 'Faible', 'medium' => 'Moyenne', 'high' => 'Indifférente'), $user->salt, array('class' => 'form-control')) }}
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-5 col-sm-7 col-xs-12">
                          {{ Form::select('sugar', array('low' => 'Faible', 'medium' => 'Moyenne', 'high' => 'Indifférente'), $user->sugar, array('class' => 'form-control')) }}
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-5 col-sm-7 col-xs-12">
                          {{ Form::select('fat', array('low' => 'Faible', 'medium' => 'Moyenne', 'high' => 'Indifférente'), $user->fat, array('class' => 'form-control')) }}
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-5 col-sm-7 col-xs-12">
                          {{ Form::select('saturedFat', array('low' => 'Faible', 'medium' => 'Moyenne', 'high' => 'Indifférente'), $user->saturedFat, array('class' => 'form-control')) }}
                        </div>
                      </div>
